...
using Plugins.Zenject.OptionalExtras.IntegrationTests.Bindings.TestFromSubContainerPrefab;
...
namespace Plugins.Zenject.OptionalExtras.IntegrationTests.Tests.Bindings.TestFromSubContainerPrefab
{
