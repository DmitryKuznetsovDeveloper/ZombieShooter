...
using Plugins.Zenject.OptionalExtras.IntegrationTests.Bindings.TestFromPrefabResource;
...
using Zenject;
namespace Plugins.Zenject.OptionalExtras.IntegrationTests.Tests.Bindings.TestFromPrefabResource
{
