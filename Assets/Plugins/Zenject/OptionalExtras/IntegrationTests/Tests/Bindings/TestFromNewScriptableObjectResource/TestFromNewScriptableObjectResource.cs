...
using Plugins.Zenject.OptionalExtras.IntegrationTests.Bindings.TestFromNewScriptableObjectResource;
using Plugins.Zenject.OptionalExtras.TestFramework;
using Plugins.Zenject.Source.Internal;
using UnityEngine.TestTools;
namespace Plugins.Zenject.OptionalExtras.IntegrationTests.Tests.Bindings.TestFromNewScriptableObjectResource
{
