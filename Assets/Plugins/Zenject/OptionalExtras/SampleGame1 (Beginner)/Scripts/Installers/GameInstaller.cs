...
using Plugins.Zenject.OptionalExtras.SampleGame1__Beginner_.Scripts.Main;
...
using Plugins.Zenject.OptionalExtras.SampleGame1__Beginner_.Scripts.Ship.States;
...
using UnityEngine;
using Zenject;
namespace Plugins.Zenject.OptionalExtras.SampleGame1__Beginner_.Scripts.Installers
{
